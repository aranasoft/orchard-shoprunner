...
namespace ShopRunner
{
    public class Migrations : DataMigrationImpl
    {
        ...
        public int Create()
        {
            SchemaBuilder.DropTable("ShopRunnerPartRecord");
            SchemaBuilder.DropTable("ShopRunnerDivNameRecord");
            SchemaBuilder.DropTable("ShopRunnerSettingsPartRecord");
        ...
        public int UpdateFrom1()
        {
            ...
            foreach (ShopRunnerDivNameRecord divName in _divNames)
            {
